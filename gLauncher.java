...
public class gLauncher extends d20weaponsystem
{
	//-------------------------------------------------------------------
	...
	static Random randomBaseGL = new Random();
	String[] effectArray = {"","",""};
	String effect="", effectIntensity="", effectChance="";

	//-------------------------------------------------------------------
	//Begin gLauncherStats Method
	//-------------------------------------------------------------------
	public String[] gLauncherStats(int lvlI)
	{
		lvlInt = lvlI; //gets level
		damageModInt = 0; //sets the damage modifier variable to 0

		int randomBaseIntGL = randomBaseGL.nextInt(100)+1;

		if(randomBaseIntGL<=35){
			manuName = "M:I ";
			baseName = "Bulldog ";
			weapName = "M:I Grenade Launcher";
			dmgDiceModel = "F";
		...
		else if(randomBaseIntGL>35 && randomBaseIntGL<=45){
			manuName = "Bohr ";
			baseName = "SLUG ";
			weapName = "Bohr SLUG Grenade Launcher";
			dmgDiceModel = "R";

			accuracyBaseInt = -2;
			damageBase = "6d6(1d6 X3)";
			magazineBaseInt = 4;
			FRBaseDouble = .5;
			rangeBaseInt = 60;
			reloadBase = "1 Rnd.";
		...
		else if(randomBaseIntGL>45 && randomBaseIntGL<=55){
			manuName = "Granzik ";
			baseName = "Hailstorm ";
			weapName = "Granzik Hail Grenade Launcher";
			dmgDiceModel = "Y";
		...
		else if(randomBaseIntGL>55 && randomBaseIntGL<=90){
			manuName = "MechTec ";
			baseName = "Harbinger ";
			weapName = "MechTec Grenade Launcher";
			dmgDiceModel = "C";
		...
		else if(randomBaseIntGL>90 && randomBaseIntGL<=100){
			manuName = "Rockholm ";
			baseName = "Marauder ";
			weapName = "Rockholm Fountain Grenade Launcher";
			dmgDiceModel = "N";

			accuracyBaseInt = -1;
			damageBase = "2d6(1d6 X4)";
			magazineBaseInt = 6;
			FRBaseDouble = .5;
			rangeBaseInt = 40;
			reloadBase = "1 Rnd.";
		...
		//---------------------------------------------------------------------------------------------------------------
		//Critical Hit Modification *ONLY FOR SLUG*
		//---------------------------------------------------------------------------------------------------------------

		boolean critTxt = false;
		int randomCritModInt = randomBase.nextInt(100)+1;

		if(randomCritModInt<=(5+((lvlInt-1)*1)) && slugBo==true){
			critTxt = true;
			rarityInt = rarityInt+30;
		}
		...
		displayText = displayText+"Grenade Launcher"+"\n"+weapName+"\nDamage: "+damageBase+"\nAccuracy: "+accuracyBase+"\nMagazine: "
			+magazineBase+"\nFire Rate: "+firerateBase+"\nRange: "+rangeBase+" ft.\nReload: "+reloadBase+"\nWeight: "+wgtBase
			+"\n"+descriptionTxt+"\n";

		displayArray[0] = "Grenade Launcher";
